...
concept = (pd.read_csv(os.path.join(vocab_dir, 'CONCEPT.csv'),sep='\t',
                      dtype={
                          'concept_id' : 'int'
                      }))
concept.head()
...
concept_relationship = (pd.
                        read_csv(os.path.join(vocab_dir,
...
pickle.dump(
    ids,
    open(os.path.join(data_root, 'all_openFDA_rxnorm_concept_ids.pkl'),'wb')
)
...
pickle.dump(
    ...
    open(os.path.join(data_root, 'all_openFDA_meddra_concept_ids.pkl'),'wb')
)
...
all_openFDA_rxnorm_concept_ids = pickle.load(
    open(os.path.join(data_root, 'all_openFDA_rxnorm_concept_ids.pkl'),'rb')
)
